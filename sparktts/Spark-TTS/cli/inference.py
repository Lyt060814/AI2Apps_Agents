cuda:0# Copyright (c) 2025 SparkAudio
...
def parse_args():
    ...
    parser.add_argument("--device", type=str, default="cpu", help="CUDA device number")
    parser.add_argument(
    ...
    parser.add_argument(
        "--save_path", type=str, help="Transcript of prompt audio"
    )
...
def run_tts(args):
    ...
    save_path = os.path.join(args.save_dir, f"{args.save_path}")
